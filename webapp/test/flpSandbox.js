		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "BTP Experience",
									"targetURL": "#comlab2devbtpxp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlab2devbtpxp-display": {
								"semanticObject": "comlab2devbtpxp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lab2dev.btpxp",
									"url": sap.ui.require.toUrl("com/lab2dev/btpxp")
								}
							}
						}
					}
